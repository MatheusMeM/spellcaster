...
| R5 GUI Tauri | show de 3 min do zero; Face em modo performance | base pronta em `main` (`spellgui/web`: canvaskit + timeline) e a página principal entregue em `spellgui/web/laser3d/` — o programa é o projetor laser em 3D, ligado ao registry por `bus.js`, com three.js e as fontes vendorizados para rodar sem rede; falta Tauri, painéis, Theme/Face | voto das rodadas 5 e 6 do design |

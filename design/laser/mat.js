/* Renderer, procedural PMREM environment, procedural textures and the device's materials. All with no external asset. */
window.MAT = function (THREE, R) {
  ...
  // optical bench: M4 drilling every 12.5 mm (24 × 16 over 300 × 200 mm), color + roughness texture
  ...
  // PCB: dark green mask, manhattan traces, pads, discreet silkscreen
  ...
  // box with a rounded edge (a folded plate has a radius) and a plate with a round hole (the fan ring)

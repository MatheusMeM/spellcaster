...
window.Bind = (function () {
  ...
  api = { def: def, run: run, has: function (id) { return !!A[id]; }, keyOf: keyOf, learnState: function () { return learn; }, connect: connect, html: html, click: click, feedback: feedback, syncAll: syncAll, midi: "desligado", onChange: function (f) { onChange = f; }, reset: function () { USR = { key: {}, midi: {} }; save(); onChange(); } };
  return api;
})();

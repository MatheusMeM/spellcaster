...
# ---- compatibilidade com o run_once do seed: pré-rolo de vídeo (1 s stop + 1 s replay) e canal de controle do player ----
PRE = 2.0
DUR_LUZ = DUR
DUR = DUR_LUZ + PRE
_look_luz = look
def look(t):
    ...
    o[VIDEO] = [28 if t < 1 else (20 if t < PRE else (10 if t < PRE + VIDEO_END else 28)), 0]   # ch1 controle, ch2 clipe
    return o
